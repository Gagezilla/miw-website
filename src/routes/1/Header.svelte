...
<header class="md:justify-center w-full flex absolute p-5 justify-end z-50">
    <div class="relative" use:clickOutside={closeMenu}>
        ...
        <ul class="{open ? 'transition-opacity duration-150' : 'opacity-0 pointer-events-none'} md:border-0 border-2 border-clr4 md:gap-4 md:static md:flex md:text-clr2 md:bg-transparent md:mt-0 md:opacity-100 md:pointer-events-auto absolute bg-white right-0 mt-3 p-4 rounded-xl min-w-[15rem] font-poppins text-center">
            ...
            <li><a class="block p-2 md:p-4 md:border-2 md:rounded-xl" href="/contact-us">Contact Us</a></li>
        </ul>
    </div>
</header>