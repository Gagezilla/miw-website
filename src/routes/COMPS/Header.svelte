...
<header class="md:justify-center w-full flex absolute p-5 justify-end z-50">
    <div class="relative" use:clickOutside={closeMenu}>
        ...
        <ul class="{open ? 'transition-opacity duration-150' : 'opacity-0 pointer-events-none'} md:gap-4 md:static md:flex md:text-clr2 md:bg-transparent md:mt-0 md:opacity-100 md:pointer-events-auto absolute bg-white right-0 mt-3 p-4 rounded-xl min-w-[15rem] font-poppins text-center">
